    ...
    >
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-white/90 mb-8 animate-fade-in-delay font-light">
            Connecting Innovation. Delivering Solutions.
          </p>
          
          {/* Description */}
          <p className="text-lg text-white/80 mb-12 max-w-2xl mx-auto animate-fade-in-delay">
